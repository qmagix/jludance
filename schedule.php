...
//echo "connected1";
$semester1=get_classes($conn,21);
//echo "connected2";
$semester2=get_classes($conn,22);
//echo "connected3";
$semester3=get_classes($conn,23);
//echo "connected4";
mysqli_close($conn);
?>
...
<ul class="nav nav-tabs">
  <li><a class="nav-link btn btn-primary active" data-toggle="tab" href="#home">Fall 2025</a></li>
  <li><a class="nav-link btn btn-primary" data-toggle="tab" href="#menu1">Spring 2026</a></li>
